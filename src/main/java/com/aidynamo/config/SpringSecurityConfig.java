...
//    }
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeRequests(authorizeRequests -> authorizeRequests
                        .requestMatchers("/admin/login", "/admin/register", "/admin/verify-otp").permitAll()
                        .requestMatchers("/api/campaign-manager/login").permitAll()
                        .requestMatchers("/dan/login","/dan/register").permitAll()
                        .requestMatchers("/api/user/login","/api/user/getbyemail").permitAll()
                        .requestMatchers("/api/chatgpt","/api/chatgpt/**").permitAll()
